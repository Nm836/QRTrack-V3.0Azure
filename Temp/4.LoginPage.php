...
<div class="main-container" >
      <div class="container"><img src="display1.png"/>
        <div>Enjoy ordering your favorites from home</div>
      </div>
      <div class="container"><img src="display2.png"/>
        <div>Choose from a wide range of cuisines</div>
      </div>
      <div class="container"><img src="display3.png"/>
        <div>Monitor your order with real-time tracking</div>
      </div>
      <div class="container"><img src="display4.png"/>
        <div>Receive discounts as a loyal member</div>
      </div>
    <div class="container">
        <h1>QR Track</h1>
